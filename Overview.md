...
<span class="image left">
      <img src="{{ 'assets/images/RotorConstruction1.JPG ' | absolute_url }}" alt=""/>
      Fig. 3a: *3D-printed Motor mounting attached to a servo hidden in the foot, which rotates the cag wheels and changes propeller orientation to change Mr. Turtle´s driving direction.*
</span>
<span class="image right">
      <img src="{{ 'assets/images/RotorAerial2.JPG ' | absolute_url }}" alt=""/>
      Fig. 3b: *Aerial view of the two propeller constructions in the back of the platform. There´s a void in the cylinder to store the wires savely.*
</span>
